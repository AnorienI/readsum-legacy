...
# Base URL for "History - Archaeology" category
# base_url = 'https://www.gutenberg.org/ebooks'
base_url = 'https://www.gutenberg.org/ebooks/bookshelf/686'
...
while True:
    ...
    for book in books:
        ...
        book_url = urljoin(base_url, relative_url) if relative_url else ''
                ...
                # 🌟 Extract category 🌟
        category = "Hist-Archaeology"  # You can hardcode it for now
        ...
        cursor.execute("""
            INSERT IGNORE INTO archaeology (title, author, book_url, category, publication_year, language, gutenberg_id) 
