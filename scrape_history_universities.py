...
# Base URL for "History - Universities" category
# base_url = 'https://www.gutenberg.org/ebooks'
base_url = 'https://www.gutenberg.org/ebooks/bookshelf/666'
...
while True:
    ...
    for book in books:
        ...
        book_url = urljoin(base_url, relative_url) if relative_url else ''
                ...
                # 🌟 Extract category 🌟
        category = "Hist-Universities"  # You can hardcode it for now
        ...
        cursor.execute("""
            INSERT IGNORE INTO universities (title, author, book_url, category, publication_year, language, gutenberg_id) 
