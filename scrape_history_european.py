...
# Base URL for "History - European" category
...
while True:
    ...
    for book in books:
        ...
        book_url = urljoin(base_url, relative_url) if relative_url else ''
                ...
                # 🌟 Extract category 🌟
        category = "Hist-European"  # You can hardcode it for now
        ...
        cursor.execute("""
            INSERT IGNORE INTO european (title, author, book_url, category, publication_year, language, gutenberg_id) 
